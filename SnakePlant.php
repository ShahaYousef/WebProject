  ...
  <main>
    ...
    <section class="tobic">
      <div class="tobicContent">
        ...
        <img src=" https://cdn.shopify.com/s/files/1/0260/3037/4957/products/medium-plant-golden-snake-white-pot_540x.jpg?v=1597701361" alt="Snake Plant">

        <!-- content -->
        <p>Originally from South Africa, is another hardy almost impossible to kill houseplant that thrives on neglect. </p>
        <p>  In length while other varieties, such as the Hahni, have very short compact leaves that are only 4”. NASA
           lists the Sansiviera plant as an excellent clean air plant.These plants are considered poisonous and should
        ...
        <div class="plantIcons">
          ...
          <p > A sansevieria can be placed anywhere in a room from the darkest corner to the
             brightest window. The better the light, the faster a sansevieria grows.</p>
          <pre>
          </pre>

          <!-- Part2 -->
          <h4> <i style="color: #1167b1; font-size: 25px" class="fas fa-tint"></i> Water </h4>
          <p> Over-watering is the main reason sansevieria plants die. Allow the soil to dry out before watering.
