  ...
  <main>
    ...
    <section class="tobic">
      <div class="tobicContent">
        ...
        <img src="https://res.cloudinary.com/patch-gardens/image/upload/c_fill,f_auto,h_840,q_auto:good,w_840/v1595406569/osjajg2d5pbjotrkxw7v.jpg" alt="Plant pic">

        <!-- content -->
        <p> There can hardly be a person in the UK who isn’t familiar with this plant. It grows up buildings,
           trees and anything else it can get its rootlets on. Although it’s known as English ivy,
        ...
        <!-- Sources المصادر -->
         <div>
           ...
           <a  style="display: inline-block; text-decoration: underline;"  href="https://www.patchplants.com/gb/en/plants/english-ivy-106/"> PATCH PLANTS </a>
         </div>
        </div>
