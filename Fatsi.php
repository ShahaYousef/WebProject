  ...
  <main>
    ...
    <section class="tobic">
      <div class="tobicContent">
        ...
        <img src="https://res.cloudinary.com/patch-gardens/image/upload/c_fill,f_auto,h_840,q_auto:good,w_840/v1553016888/products/fatsia-japonica-2838ac.jpg" alt="Plant pic">

        <!-- content -->
        <p> The beautiful fatsia japonica gets its name from the Japanese word ‘fatsi’, meaning ‘eight’,
           because its magnificent leaves have eight lobes. It’s found in the wild in Japan, South Korea and Taiwan,
           where it lives happily through warm summers and pretty cold winters (it can cope with temperatures as low as −15 °C).</p>
        <p> It’s become hugely popular around the world for its impressive glossy leaves. In summer,
           you should also see it bloom with small white flowers, then possibly little (inedible) black fruits. </p>
        ...
        <div class="plantIcons">
          ...
          <p > He’ll be fine in a shady spot, but equally happy somewhere that gets sun most of the day. Sun all day might be too much. </p>
          <pre>
          </pre>

          <!-- Part2 -->
          <h4> <i style="color: #1167b1; font-size: 25px" class="fas fa-tint"></i> Water </h4>
          <p> He likes his soil gently moist. Give him a drink whenever the top two inches of soil are dry and he’ll be very happy. </p>
          <pre>
          </pre>
        ...
        <!-- Sources المصادر -->
         <div>
           ...
           <a  style="display: inline-block; text-decoration: underline;"  href="https://www.patchplants.com/gb/en/plants/fatsia-japonica-67/"> PATCH PLANTS </a>
         </div>
        </div>
