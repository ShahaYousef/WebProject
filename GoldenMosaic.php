  ...
  <main>
    ...
    <section class="tobic">
      <div class="tobicContent">
        ...
        <img src=" https://assets.pbimgs.com/pbimgs/rk/images/dp/wcm/202026/0096/faux-potted-rubber-houseplant-o.jpg" alt=" Golden Mosaic Plant">

        <!-- content -->
        <p> is a member of the Marantaceae family and is
     related to the calathea and prayer plant. These evergreen perennials are grown
      primarily for the beauty of their colorful leaves. </p>
        <p> These plants are considered mildly poisonous (although often listed as non-toxic)),
           it may cause individual allergic reactions and should be kept away from pets and children.
        ...
        <div class="plantIcons">
          ...
          <p >Ctenanthes like bright indirect light. If there is insufficient light, new leaves
             appear solid green rather than patterned with attractive colors. If there is too much
             light, the colors in the leaves fade.</p>
          <pre>
          </pre>

          <!-- Part2 -->
          <h4> <i style="color: #1167b1; font-size: 25px" class="fas fa-tint"></i> Water </h4>
          <p> Keep the soil evenly moist but never soggy. Ctenanthes do not like to dry out, and do not like cold or hard water.
        </p>
          <pre>
          </pre>
          ...
          <p> High humidity is very important. If the air is dry, place your Ctenanthe on a pebble
             tray filled with water. Be sure the plant is sitting on the pebbles and not in the water.</p>
          <pre>
          </pre>
